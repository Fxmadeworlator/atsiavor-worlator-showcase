              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center h-full">
                    ...
                    {!isImageUrl && (
                      <div className="shrink-0 flex items-center justify-center w-28 h-28 mr-6 bg-white/10 backdrop-blur rounded-2xl text-5xl">
                        {currentProject.image}
                      </div>
                    )}

                    {/* text block - now takes full available width */}
