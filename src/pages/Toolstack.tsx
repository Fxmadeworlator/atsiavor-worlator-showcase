...
const MeetLogo = () => (
  <svg viewBox="0 0 24 24" className="h-6 w-6">
    <path fill="#00897B" d="M12 0C6.477 0 2 4.477 2 10c0 4.237 2.636 7.855 6.356 9.312-.088-.791-.167-2.005.035-2.868.181-.78 1.172-4.97 1.172-4.97s-.299-.598-.299-1.482c0-1.388.805-2.426 1.808-2.426.852 0 1.264.64 1.264 1.408 0 .858-.546 2.14-.828 3.33-.236.995.5 1.807 1.48 1.807 1.778 0 3.144-1.874 3.144-4.58 0-2.393-1.72-4.068-4.177-4.068-2.845 0-4.515 2.134-4.515 4.34 0 .859.331 1.781.745 2.282a.3.3 0 0 1 .069.288l-.278 1.133c-.044.183-.145.223-.335.134-1.249-.581-2.03-2.407-2.03-3.874 0-3.154 2.292-6.052 6.608-6.052 3.469 0 6.165 2.473 6.165 5.776 0 3.447-2.173 6.22-5.19 6.22-1.013 0-1.965-.527-2.292-1.148l-.623 2.378c-.226.869-.835 1.958-1.244 2.621.937.29 1.931.446 2.962.446 5.523 0 10-4.477 10-10S17.523 0 12 0z"/>
  </svg>
);

const AnalyticsLogo = () => (
  <svg viewBox="0 0 24 24" className="h-6 w-6">
    <path fill="#F9AB00" d="M22.84 2.998v17.998c0 1.105-.894 2-2 2H3.158c-1.105 0-2-.895-2-2V2.998c0-1.104.895-2 2-2h17.682c1.106 0 2 .896 2 2z"/>
    <path fill="#E37400" d="M22.84 13.498v7.498c0 1.105-.894 2-2 2H3.158c-1.105 0-2-.895-2-2v-7.498h21.682z"/>
  </svg>
);
...
const OtherTools = () => {
  ...
  const tools = [
    ...
    { name: "Analytics", icon: <AnalyticsLogo /> },
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="min-h-screen px-8 pb-20">
        ...
        <div className="max-w-3xl mx-auto space-y-12">
          {toolGroups.map((g) => (
            <ToolCategory key={g.category} category={g.category} tools={g.tools} />
          ))}
        </div>
